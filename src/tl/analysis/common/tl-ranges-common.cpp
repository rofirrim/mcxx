...
namespace {
    ...
    const_value_t* one() { return const_value_get_one(/*bytes*/ 4, /*signed*/ 1); }
    const_value_t* zero() { return const_value_get_zero(/*bytes*/ 4, /*signed*/ 1); }
